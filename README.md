...
<div align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com/?color=58A6FF&size=35&center=true&vCenter=true&width=1000&lines=Olá!+Eu+sou+o+Gabriel+Alves+🧑🏻‍💻;Estudante+de+Ciência+da+Computação;Desenvolvedor+Lua+|+The+Forgotten+Server+(TFS);Moro+em+Brasília,+DF;+:%29" alt="Typing SVG" />
  </a>
</div><br/>

<div align="center">
  <p align="center">
    🎓 <b>Ciência da Computação</b> | ⚔️ <b>Desenvolvimento de Motores de Jogo (Pokétibia/TFS)</b>
  </p>
  <p align="center">
    Atualmente mergulhado no desenvolvimento de sistemas backend e lógicas de servidores baseados em The Forgotten Server (TFS). Tenho focado na construção de arquiteturas sólidas em <b>Lua</b>, aplicando desde lógicas procedurais (Sistemas de Catch, Drops e Magias em Área AoE) até a Orientação a Objetos utilizando Metatabelas.
  </p>
</div><br/>
